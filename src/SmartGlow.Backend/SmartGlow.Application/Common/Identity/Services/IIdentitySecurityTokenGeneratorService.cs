...
public interface IIdentitySecurityTokenGeneratorService
{
    ...
    /// </summary>
    /// <param name="client">User to create refresh token for</param>
    ...
    /// </summary>
    /// <param name="client">The user for whom the token is generated.</param>
    ...
    /// </summary>
    /// <param name="client">The user for whom claims are generated.</param>
    /// <param name="accessToken">The associated access token.</param>
