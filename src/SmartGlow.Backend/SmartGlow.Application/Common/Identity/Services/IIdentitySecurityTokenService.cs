...
public interface IIdentitySecurityTokenService
{
    ...
    /// </summary>
    /// <param name="refreshTokenValue">The refresh token to create</param>
    /// <param name="commandOptions"></param>
    /// <param name="cancellationToken">Cancellation token to stop the operation if needed (default is none)</param>
    ...
    /// </summary>
    /// The unique token value of the refresh token to get
    /// Cancellation token to stop the operation if needed (default is none)param>
